...
require_once 'components/sections/NewsHeroSection.php';
...
class NewsPageComponents
{
   public function __render()
   {
      return <<<HTML
         <NewsHeroSection />
         <NewsPageComponents::BreakingNewsBanner />
         <NewsPageComponents::MainSection />
      HTML;
   }
   ...
   public function BreakingNewsBanner()
   {
      return <<<HTML
