         ...
         <header class="bg-white bg-opacity-90 backdrop-blur-md text-gray-800 shadow-lg sticky top-0 z-50">
            <div class="container mx-auto px-4 py-6 flex justify-between items-center">
               ...
               <div class="hidden md:flex space-x-8">
                  ...
                  <Component.Link to="/" children="Home" class="hover:text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-lg font-medium transition-all duration-300" />
                  <Component.Link to="/analysis" children="Analysis" class="hover:text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-lg font-medium transition-all duration-300" />
                  <Component.Link to="/news" children="News" class="text-indigo-600 bg-indigo-50 px-4 py-2 rounded-lg font-medium" />
                  <Component.Link to="/learn/forex" children="Learn" class="hover:text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-lg font-medium transition-all duration-300" />
                  <Component.Link to="/tools" children="Tools" class="hover:text-indigo-600 hover:bg-indigo-50 px-4 py-2 rounded-lg font-medium transition-all duration-300" />
               </div>
